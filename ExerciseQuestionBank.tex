...
\problem{
  4.2.4 Could we have defined the inner product on $\C^n$ by $\langle \vec{\alpha}, \vec{\beta} \rangle = \sum_{i=1}^{n} {\alpha_i}\overline{\beta_i}$. Would it be an inner product over $\C$?
}
\begin{solution}
  % ==== Place for solution here ====
\end{solution}
